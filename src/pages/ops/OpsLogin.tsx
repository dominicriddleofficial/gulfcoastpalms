      ...
      <div className="w-full max-w-sm space-y-6">
        <Card className="border-border bg-card shadow-2xl shadow-primary/5">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="font-display text-xl text-foreground">Gulf Coast Palms</CardTitle>
            <p className="font-body text-sm text-primary/70">Operations Dashboard</p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button type="submit" className="w-full h-11 font-body font-semibold bg-primary text-primary-foreground hover:bg-primary/90" disabled={loading}>
                {loading ? "Signing in..." : "Sign In"}
              </Button>
            </form>
          </CardContent>
        </Card>
        <p className="text-center font-body text-xs text-muted-foreground">Powered by Gulf Coast Palms</p>
      </div>
    </div>
  );
};
