...
export default function PlatformQuoteDisplay() {
  return (
    <PlatformLayout>
      {/* Outer dark canvas */}
      <div className="min-h-[calc(100vh-80px)] -m-4 md:-m-6 flex items-start justify-center px-3 py-8 md:py-14"
        style={{ background: "#09090b" }}>

        {/* Aura glow behind card */}
        <div className="relative w-full max-w-2xl">
          {/* Radial glow */}
          <div className="absolute inset-0 -inset-x-20 -inset-y-24 pointer-events-none"
            style={{
          ...
          <div className="relative rounded-2xl overflow-hidden"
            ...
            <div className="p-5 md:p-7">
              {/* Header row */}
              <div className="grid grid-cols-[1fr_48px_80px_80px] gap-2 pb-2 mb-1 text-[10px] uppercase tracking-wider font-semibold"
                      ...
                      <div className="shrink-0">
                        {m.status === "paid" ? (
                          ...
                          <div className="w-7 h-7 rounded-full border-2 flex items-center justify-center"
                            style={{ borderColor: m.status === "next" ? "#22c55e" : "#333" }} />
                        )}
                      </div>
                      ...
                      <div className="shrink-0">
                        ...
                        {m.status === "next" && (
                          <div className="flex flex-col items-end gap-1">
                            ...
                            <button className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all hover:shadow-[0_0_16px_rgba(34,197,94,0.25)]"
                        ...
                        {m.status === "upcoming" && (
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-semibold"
                            style={{ background: "rgba(161,161,170,0.1)", color: "#71717a" }}>
                            Upcoming
                          </span>
                        )}
                      </div>
