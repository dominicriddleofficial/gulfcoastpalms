...
import {
  ChevronDown, Wrench, Shield, Clock, TrendingUp,
  CheckCircle, Upload, Mic, Star,
} from "lucide-react";

const GroundsmanCareers = () => {
    ...
    <Layout>
      ...
      <section className="relative bg-foreground text-background overflow-hidden">
        ...
        <div className="container mx-auto section-padding relative z-10 text-center max-w-4xl">
          ...
          <h1 className="font-display text-4xl md:text-6xl font-bold mb-6 text-white">Groundsman</h1>
          <p className="font-body text-lg md:text-xl text-white/70 mb-4 max-w-2xl mx-auto">
            Support the crew from the ground on palm tree trimming jobs across the Gulf Coast.
          </p>
          ...
          <div className="bg-card border border-border rounded-xl overflow-hidden">
            <div className="bg-foreground p-5">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-display text-xl font-bold text-white">Groundsman Responsibilities</h3>
              </div>
            </div>
            <ul className="p-6 space-y-3">
              {[
                "Helps the climber and team leader from the ground",
                "Drags brush and palm limbs to the pile area",
                "Builds piles efficiently for fast trailer loading",
                "Helps load the trailer the right way — tight and organized",
                "Helps protect the customer's property at all times",
                "Holds ladders when needed for safety",
                "Keeps batteries, chargers, tools, and cleanup organized",
                "Works with pace, awareness, and a sense of urgency",
                "Follows direction and communicates clearly with the crew",
              ].map((item) => (
      ...
      <section className="section-padding bg-background">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: TrendingUp, title: "Starting at $20/hr", desc: "Groundsman positions start around $20/hr during the first month and can move up to $25/hr based on performance." },
              { icon: Star, title: "Room to Grow", desc: "Prove yourself as a Groundsman and grow into a Team Leader role over time." },
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            <p className="font-body text-muted-foreground">
              Experience in tree work, landscaping, trailers, cleanup, or outdoor labor is a plus. But we're open to the right person if they have the <span className="font-semibold text-foreground">attitude, discipline, and work ethic</span> to learn.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-secondary/30" ref={formRef} id="apply">
        <div className="container mx-auto max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="bg-card border border-border rounded-xl p-6 md:p-8 space-y-6">
            ...
            <div className="space-y-2">
              <Label className="font-body font-semibold">Do you have relevant experience? (e.g. tree work, landscaping, trailers, cleanup, outdoor labor)</Label>
            ...
            <div className="space-y-2">
              <Label className="font-body font-semibold">Why do you think you'd be a good fit for Groundsman?</Label>
...
export default GroundsmanCareers;
