...
export const rawRoutes = [
  ...
  { path: "/palm-tree-trimming-pensacola-fl", title: "Palm Tree Trimming Pensacola FL | Gulf Coast Palms", description: "Professional palm tree trimming in Pensacola, FL. Diamond cutting, trunk skinning, installs & removals. 5.0★ · 46 reviews · free estimates. (850) 910-1290." },
  { path: "/palm-tree-trimming-gulf-breeze-fl", title: "Palm Tree Trimming Gulf Breeze FL | Gulf Coast Palms", description: "Expert palm tree trimming in Gulf Breeze, FL. Resort-quality diamond cutting, trunk skinning & coastal palm care. 5.0★ · 46 reviews · (850) 910-1290." },
  { path: "/palm-tree-trimming-navarre-fl", title: "Palm Tree Trimming Navarre FL | Gulf Coast Palms", description: "Navarre's leading palm tree trimming crew. Diamond cutting, trunk skinning & large-scale palm care. 5.0★ · 46 reviews · free estimates — (850) 910-1290." },
  { path: "/palm-tree-trimming-fort-walton-beach-fl", title: "Palm Tree Trimming Fort Walton Beach FL | Gulf Coast Palms", description: "Palm tree trimming in Fort Walton Beach, FL. Diamond cutting, trunk skinning & condo palm care. 5.0★ · 46 reviews · free estimates — (850) 910-1290." },
  { path: "/palm-tree-trimming-destin-fl", title: "Palm Tree Trimming Destin FL | Diamond Cutting | Gulf Coast Palms", description: "Palm tree trimming in Destin, FL. Diamond cutting specialists for luxury homes, HOAs & vacation rentals. 5.0★ · 46 reviews · free quote — (850) 910-1290." },
  ...
  { path: "/palm-tree-trimming-perdido-key-fl", title: "Palm Tree Trimming Perdido Key FL | Gulf Coast Palms", description: "Palm tree trimming on Perdido Key, FL. Diamond cutting & condo palm care for barrier island properties. 5.0★ · 46 reviews · free quote — (850) 910-1290." },
  { path: "/palm-tree-trimming-niceville-fl", title: "Palm Tree Trimming Niceville FL | Gulf Coast Palms", description: "Palm tree trimming in Niceville, FL — Bluewater Bay, Rocky Bayou & Twin Cities. 5.0★ · 46 reviews · free estimates — call (850) 910-1290." },
  { path: "/palm-tree-trimming-mary-esther-fl", title: "Palm Tree Trimming Mary Esther FL | Gulf Coast Palms", description: "Palm tree trimming in Mary Esther, FL. Trusted by military families & property managers near Hurlburt Field. 5.0★ · 46 reviews — call (850) 910-1290." },
  { path: "/palm-tree-trimming-santa-rosa-beach-fl", title: "Palm Tree Trimming Santa Rosa Beach FL | 30A | Gulf Coast Palms", description: "Premium palm tree trimming in Santa Rosa Beach, FL — WaterColor, WaterSound & 30A luxury homes. 5.0★ · 46 reviews · free quote — (850) 910-1290." },
  { path: "/palm-tree-trimming-pace-fl", title: "Palm Tree Trimming Pace FL | Gulf Coast Palms", description: "Palm tree trimming in Pace, FL. Serving Santa Rosa County's fastest-growing community. 5.0★ · 46 reviews · free estimates — (850) 910-1290." },
  { path: "/palm-tree-trimming-milton-fl", title: "Palm Tree Trimming Milton FL | Gulf Coast Palms", description: "Palm tree trimming in Milton, FL — Blackwater River to Highway 90. 5.0★ · 46 reviews · free estimates — call Gulf Coast Palms at (850) 910-1290." },
