/**
 * Homepage FAQ copy, extracted from src/components/home/FAQ.tsx so that the
 * build-time SEO prerender (scripts/prerender-meta.mjs) can inject the same
 * words into the static HTML. Wording is unchanged.
 */
