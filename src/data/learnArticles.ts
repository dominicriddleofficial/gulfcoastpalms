/**
 * Learn-hub article copy. Extracted verbatim from LearnArticle.tsx so the
 * build-time SEO static-content generator can inject the same words into
 * the prerendered HTML. Wording is unchanged.
 */
