...
const FLAKE_TEMPLATE: ChecklistItemTemplate[] = [
  ...
  { id: "fl-prep-60grit", section: "PREP & GRINDING", label: "60 grit sandpaper", hasQuantity: true },
...
const METALLIC_TEMPLATE: ChecklistItemTemplate[] = [
  ...
  { id: "mt-prep-60grit", section: "PREP & GRINDING", label: "60 grit sandpaper", hasQuantity: true },
