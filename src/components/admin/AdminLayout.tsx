...
const ROLE_ACCESS: Record<UserRole, string[]> = {
  ...
  operations: ["/admin", "/admin/leads", "/admin/clients", "/admin/jobs", "/admin/reviews", "/admin/leaderboards"],
  team_leader: ["/admin", "/admin/jobs", "/admin/reviews", "/admin/leaderboards"],
  limited_staff: ["/admin"],
  user: ["/admin"],
};
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className={cn(
        ...
        <div className="p-5 border-b border-border flex items-center justify-between">
          <div>
            <h2 className="font-display text-lg font-bold text-foreground">Gulf Coast Palms</h2>
            <p className="font-body text-xs text-muted-foreground capitalize">{userRole.replace("_", " ")} Panel</p>
          </div>
        ...
        <div className="p-3 border-t border-border">
          <Button variant="ghost" size="sm" className="w-full justify-start font-body text-muted-foreground" onClick={handleSignOut}>
